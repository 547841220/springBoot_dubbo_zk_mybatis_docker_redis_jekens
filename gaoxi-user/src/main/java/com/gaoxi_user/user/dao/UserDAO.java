package com.gaoxi_user.user.dao;


import com.gaoxi_common_service_facade.entity.user.*;
import com.gaoxi_common_service_facade.req.user.LocationUpdateReq;
import com.gaoxi_common_service_facade.req.user.RoleMenuReq;
import com.gaoxi_common_service_facade.req.user.RolePermissionReq;
import com.gaoxi_common_service_facade.req.user.UserQueryReq;
